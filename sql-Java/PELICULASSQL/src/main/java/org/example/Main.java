...
public class Main
{
    ...
    public static final String URLPostgre = "jdbc:postgresql://netflix-01.cbwogkym8g1j.us-east-1.rds.amazonaws.com/postgres";
    public static final String USERPostgre= "postgres";
    public static final String PASSPostgre = "Conejito_a1";
...
// 📌 Lista donde guardaremos las películas con sus géneros
        ...
        try {
            ...
            // 📌 Consulta con JOIN entre películas y género
            String query = "SELECT p.id, p.titulo, p.descripcion, p.anio, g.titulo as genero_titulo " +
                    "FROM peliculas1 p " +
                    "JOIN genero1 g " +
                    "ON p.genero_id = g.id";
            ...
            try (Statement st = conn.createStatement();
                ...
                while (rs.next()) {
                    ...
                    // Crear el objeto Genero usando setters
                    Genero genero = new Genero();
                    genero.setGeneroTitulo(generoTitulo);
